...
#     check_unit_and_employee_privilege_on_read_db(orm_execute_state, Condition)
#
#
# @event.listens_for(Condition, 'before_insert')
...
#
#
# @event.listens_for(Condition, 'before_delete')
...
#
#
# @event.listens_for(Condition, 'after_delete')
