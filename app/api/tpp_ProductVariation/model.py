...
class tpp_ProductVariation(db.Model):
    __tablename__ = f'{modelName}'
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    condition_id = db.Column(db.Integer, nullable=True)
...
#     check_unit_and_employee_privilege_on_read_db(orm_execute_state, ProductVariation)
#
#
# @event.listens_for(ProductVariation, 'before_insert')
...
#
#
# @event.listens_for(ProductVariation, 'before_delete')
...
# @event.listens_for(ProductVariation, 'after_insert')
...
#
#
# @event.listens_for(ProductVariation, 'after_update')
...
#
#
# @event.listens_for(ProductVariation, 'after_delete')
