...
#     check_unit_and_employee_privilege_on_read_db(orm_execute_state, ProductImage)
#
#
...
#
#
# @event.listens_for(ProductImage, 'before_delete')
...
#
#
# @event.listens_for(ProductImage, 'after_update')
