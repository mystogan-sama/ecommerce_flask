...
#     check_unit_and_employee_privilege_on_read_db(orm_execute_state, Size)
#
#
# @event.listens_for(Size, 'before_insert')
...
#
#
# @event.listens_for(Size, 'before_update')
# def check_unit_privilege_delete(mapper, connection, target):
#     member_of_list = current_user['member_of_list']
#     check_unit_privilege_on_changes_db(mapper, connection, target, member_of_list)
#
#
# @event.listens_for(Size, 'before_delete')
...
# @event.listens_for(Size, 'after_insert')
...
#
#
# @event.listens_for(Size, 'after_update')
...
#
#
# @event.listens_for(Size, 'after_delete')
